            ...
            @foreach ($categories as $category)
                <li class="mb-2">
                    <a href="#" wire:click.prevent="filterByCategory('{{ $category->id }}')"
                        class="p-2 rounded-md flex bg-slate-900 items-center gap-2 text-white/60 hover:text-white font-semibold text-xs capitalize">
                    ...
                    <div class="w-full">
                        ...
                        <p class="flex items-center justify-between w-full text-xs">
                            ...
                            <span class="flex items-center gap-1 text-slate-700">
                                <svg data-slot="icon" class="h-4" fill="currentColor" viewBox="0 0 24 24"
